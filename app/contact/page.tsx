      ...
      <Section className="py-6 sm:py-12">
        <div className="max-w-3xl space-y-6 sm:space-y-8">
          ...
          <AnimateIn duration={350}>
            <div className="p-6 sm:p-8 rounded-xl bg-[#f7f8e8] border border-[#d6dba0] space-y-4">
              ...
              <p className="text-xl sm:text-2xl font-sans text-[#5c6b2f] break-all font-semibold">
                {profileData.email}
              </p>
              <div className="pt-2">
                <Button
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 pt-4">
            ...
            <AnimateIn delay={50} duration={300}>
              <a
                ...
                className="block group p-5 rounded-xl bg-[#f7f8e8] border border-[#d6dba0] hover:border-[#5c6b2f] hover:-translate-y-1 hover:rotate-[0.3deg] transition-all duration-200 active:scale-[0.98]"
              >
            ...
            <AnimateIn delay={125} duration={300}>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block group p-5 rounded-xl bg-[#f7f8e8] border border-[#d6dba0] hover:border-[#b34716] hover:-translate-y-1 hover:rotate-[0.3deg] transition-all duration-200 active:scale-[0.98]"
              >
                <div className="flex items-center justify-between mb-3">
            ...
            <AnimateIn delay={150} duration={300}>
              <div className="p-5 rounded-xl bg-[#f7f8e8] border border-[#d6dba0]">
                <div className="flex items-center justify-between mb-3">
